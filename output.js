//Tue Mar 11 2025 19:29:14 GMT+0000 (Coordinated Universal Time)
...
let D_j_0x2ea766 = Math.round(new Date().getTime() / 1000).toString();
var D_j_0x54a58f = "";
var D_j_0x1adb53 = "";
let D_j_0x133d03 = "";
let D_j_0x1a085d = "";
...
async function D_j_0x1b906a(_0x348a52) {
  let _0x5caa9e = Math.round(new Date().getTime() / 1000).toString() + "000";
...
async function D_j_0x1fee11(_0x43cf1c) {
  let _0x538258 = Math.round(new Date().getTime() / 1000).toString() + "000";
  ...
  return new Promise((_0xbff78, _0x49d2dc) => {
    {
      ...
      D_j_0x3c96c7.post(_0x38cb04, async (_0x16bb1f, _0xb2031a, _0x3830d1) => {
        {
          const _0x194c8e = _0x3830d1.replace(/\"/g, "");
          _0xbff78();
        }
      });
    }
  ...
  return new Promise((_0x315ea8, _0x4940a1) => {
    {
      ...
      D_j_0x3c96c7.post(_0x21e9ba, async (_0x2c7ba0, _0x1ad698, _0x4685df) => {
        {
          const _0x510133 = _0x4685df.replace(/\"/g, "");
          _0x315ea8();
        }
      });
    }
